...
주요상품군이란 다른 제품군과 비교하여 많이 팔리는 제품군, 예를 들어 <2017년 3월 온라인쇼핑 동향 - 통계청> 자료 참고 

### 온라인 선호지수란(Preference Score)  
사용자가 이용하는 다른 아이템들에 비해 해당 아이템에 대한 이용지수가 높을수록 선호지수 값이 높게 나타난다.  
여러 가지 선택 가능한 옵션 중에서 특정 카테고리나 상품, 검색어에 맞게 고객을 유도할 때 활용가능하다.

* 즉, 주요 상품군별 온라인 선호 지수란 어떤 사람이 제품을 구매하고 난 이력을 바탕으로 상품군들에 대한 그 사람의 선호하는 정도를 이야기하는 지표이다.

* 먼저 구매량(a) 지수 하나로 만들어보자.
